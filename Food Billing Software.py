...
import random
root =Tk()
root.geometry("1080x700+0+0")
root.title("Food Billing System")
root.configure(background='black')

Tops = Frame(root,bg='grey',bd=20,pady=5,relief=RIDGE)
Tops.pack(side=TOP)

lblTitle=Label(Tops,font=('arial',35,'bold'),text='Food Billing System',bd=21,bg='black',
                fg='cornsilk',justify=CENTER)
lblTitle.grid(row=0)


ReceiptCal_F = Frame(root,bg='grey',bd=10,relief=RIDGE)
ReceiptCal_F.pack(side=RIGHT)

Buttons_F=Frame(ReceiptCal_F,bg='grey',bd=3,relief=RIDGE)
Buttons_F.pack(side=BOTTOM)

Cal_F=Frame(ReceiptCal_F,bg='grey',bd=6,relief=RIDGE)
Cal_F.pack(side=TOP)

Receipt_F=Frame(ReceiptCal_F,bg='grey',bd=4,relief=RIDGE)
Receipt_F.pack(side=BOTTOM)

MenuFrame = Frame(root,bg='grey',bd=10,relief=RIDGE)
MenuFrame.pack(side=LEFT)
Cost_F=Frame(MenuFrame,bg='grey',bd=4)
Cost_F.pack(side=BOTTOM)
Drinks_F=Frame(MenuFrame,bg='grey',bd=4)
Drinks_F.pack(side=TOP)


Drinks_F=Frame(MenuFrame,bg='grey',bd=4,relief=RIDGE)
Drinks_F.pack(side=LEFT)
Food_F=Frame(MenuFrame,bg='grey',bd=4,relief=RIDGE)
...
txtColdCoffee = Entry(Drinks_F,font=('arial',16,'bold'),bd=8,width=6,justify=LEFT,state=DISABLED,textvariable=E_ColdCoffee)
txtColdCoffee.grid(row=7,column=1)


HotDog = Checkbutton(Food_F,text="HotDog\t\t\t ",variable=var9,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='purple',command=chk_HotDog).grid(row=0,sticky=W)
VegBurger = Checkbutton(Food_F,text="VegBurger",variable=var10,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='purple',command=chk_VegBurger).grid(row=1,sticky=W)
Pasta = Checkbutton(Food_F,text="Pasta ",variable=var11,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='purple',command=chk_Pasta).grid(row=2,sticky=W)
HamBurger = Checkbutton(Food_F,text="Rice Plate ",variable=var12,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='purple',command=chk_HamBurger).grid(row=3,sticky=W)
Sandwich = Checkbutton(Food_F,text="Sandwich ",variable=var13,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='purple',command=chk_Sandwich).grid(row=4,sticky=W)
Fires = Checkbutton(Food_F,text="Fires ",variable=var14,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='purple',command=chk_Fires).grid(row=5,sticky=W)
Spagetti = Checkbutton(Food_F,text="Spagetti ",variable=var15,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='purple',command=chk_Spagetti).grid(row=6,sticky=W)
Fazitas = Checkbutton(Food_F,text="Fazitas ",variable=var16,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='purple',command=chk_Fazitas).grid(row=7,sticky=W)
...
lblCostofDrinks=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Drinks\t',bg='purple',
...
lblCostofFood=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Foods  ',bg='purple',
                fg='black',justify=CENTER)
...
lblServiceCharge=Label(Cost_F,font=('arial',14,'bold'),text='Service Charge',bg='purple',
                fg='black',justify=CENTER)
...
lblPaidTax=Label(Cost_F,font=('arial',14,'bold'),text='\tPaid Tax',bg='purple',bd=7,
                fg='black',justify=CENTER)
...
lblSubTotal=Label(Cost_F,font=('arial',14,'bold'),text='\tSub Total',bg='purple',bd=7,
                fg='black',justify=CENTER)
...
lblTotalCost=Label(Cost_F,font=('arial',14,'bold'),text='\tTotal',bg='purple',bd=7,
                fg='black',justify=CENTER)
...
btn1=Button(Cal_F,padx=16,pady=1,bd=7,fg='black', font=('arial',16,'bold'),width=4,text='1',
                        bg='yellow',command=lambda:btnClick(1)).grid(row=4,column=0)
btn2=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial', 16, 'bold'),width=4,text='2',
                        bg='yellow',command=lambda:btnClick(2)).grid(row=4, column=1)
btn3=Button(Cal_F,padx=16,pady=1,bd=7,fg='black',font=('arial', 16, 'bold'), width=4, text='3',
                        bg='yellow',command=lambda:btnClick(3)).grid(row=4, column=2)
btnMulti = Button(Cal_F, padx=16, pady=1, bd=7 ,fg='black', font=('arial', 16, 'bold'),width=4,text='*',bg='yellow',command=lambda:btnClick('*')).grid(row=4,column=3)
btn0 = Button(Cal_F, padx=16, pady=1, bd=7, fg='black', font=('arial', 16, 'bold'), width=4, text='0', bg='yellow', command=lambda: btnClick(0)).grid(row=5, column=0)
btnClear = Button(Cal_F, padx=16, pady=1,bd=7,fg='black', font=('arial', 16, 'bold'), width=4, text='C', bg='yellow', command=btnClear).grid(row=5, column=1)
btnEqual = Button(Cal_F, padx=16, pady=1, bd=7, fg='black', font=('arial', 16, 'bold'), width=4, text='=', bg='yellow', command=btnEquals).grid(row=5, column=2)
btnDiv = Button(Cal_F,padx=16, pady=1, bd=7, fg='black', font=('arial', 16, 'bold'), width=4, text='/', bg='yellow', command=lambda: btnClick('/')).grid(row=5, column=3)
root.mainloop()